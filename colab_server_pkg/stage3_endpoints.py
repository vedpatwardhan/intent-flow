...
def encode_obs_to_latent(obs_dict, state):
    ...
    with torch.amp.autocast("cuda"):
        ...
        edge_tok = state.stage3_models["edge_adapter"](obs_dict["edge"])
...
def ensure_stage3_models():
    ...
    state.stage3_models["edge_adapter"] = EdgeAdapter(d_in=384, d_out=512).to(device)
    ...
    state.stage3_optimizer = torch.optim.AdamW(
        ...
        + list(state.stage3_models["edge_adapter"].parameters())
